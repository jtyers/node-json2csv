...
// Lifted from https://gist.github.com/paulgambill/cacd19da95a1421d3164
...
function ImportJSONAdvanced(url, query, options, includeFunc, transformFunc) {
  ...
  return parseJSONObject_(object, query, options, includeFunc || includeXPath_, transformFunc || defaultTransform_);
}
 ...
 */
function parseJSONObject_(object, query, options, includeFunc = includeXPath_, transformFunc = defaultTransform_) {
...
exports.parseJSONObject_ = parseJSONObject_
...
object = JSON.parse(fs.readFileSync(0)) // stdin
csvData = parseJSONObject_(object, "/", null, includeXPath_, defaultTransform_)
...
csvData.forEach(l => stringifier.write(l))
stringifier.end()
